...
export default function PlacesDashboard() {
  ...
  const options = {
    ...
    title: { text: 'Students by Place' },
    colors: ['#e53935'],
    stroke: { width: 2 },
    fill: { opacity: 0.4 },
  };
  const series = [{ name: 'Count', data: Object.values(placeCounts) }];

  return (
    <Box sx={{ p: 2 }}>
      <Typography variant="h4" sx={{ fontWeight: 700, mb: 2, textAlign: 'center' }}>Places Dashboard</Typography>
